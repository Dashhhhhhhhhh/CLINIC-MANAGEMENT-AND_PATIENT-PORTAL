      ...
      <div style={{ marginTop: "2rem" }}>
        ...
        <form>
            ...
            <input
                ...
                onChange={(e) => 
                    setAddPatients({ ...addPatients, first_name: e.target.value })
                }
            />
            <p>Middle Initial</p>
            <input
                ...
                onChange={(e) => 
                    setAddPatients({ ...addPatients, middle_initial: e.target.value })
                }
            />
            <p>Last Name</p>
            <input
                ...
                onChange={(e) => 
                    setAddPatients({ ...addPatients, last_name: e.target.value })
                }
            />
            <p>Birthdate</p>
            <input 
                ...
                onChange={(e) => 
                    setAddPatients({ ...addPatients, birthdate: e.target.value})
                }
                />
            <label>
            Medical History:
            <textarea
                ...
                onChange={(e) => 
                    setAddPatients({ ...addPatients, medical_history: e.target.value })
                }
            />
            </label>
            <p>Contact Number</p>
            ...
            <input
                ...
                onChange={(e) => 
                    setAddPatients({ ...addPatients, street_name: e.target.value })
                }
            />
            ...
            <input
                ...
                onChange={(e) => 
                    setAddPatients({ ...addPatients, barangay_subdivision: e.target.value })
                }
            />
            ...
            <input
                ...
                onChange={(e) => 
                    setAddPatients({ ...addPatients, city_municipality: e.target.value })
                }
            />
            <p>Province</p>
            <input
                ...
                onChange={(e) => 
                    setAddPatients({ ...addPatients, province: e.target.value })
                }
            />
            <p>Postal Code</p> 
            <input
            ...
            <input
                ...
                onChange={(e) => 
                    setAddPatients({ ...addPatients, country: e.target.value})
                }
            />                        
      ...
      {/* ================= Search Staff By ID ================= */}
        <div style={{ marginTop: "2rem" }}>
            ...
            {isEditing && ( 
                ...
                onChange={(e) => setEditPatients({ ...editPatients, middle_initial: e.target.value })}
                />
                <p>Last Name</p>
                <input
                text="text"
                ...
                <input 
                    ...
                    onChange={(e) => 
                        setEditPatients({ ...editPatients, birthdate: e.target.value})
                    }
                    />
            <label>
            Medical History:
            ...
            <input
                ...
                onChange={(e) => 
                    setEditPatients({ ...editPatients, street_name: e.target.value })
                }
            />
            <p>Barangay/Subdivision</p>
            <input
            ...
            <input
                ...
                onChange={(e) => 
                    setEditPatients({ ...editPatients, province: e.target.value })
                }
            />
            <p>Postal Code</p> 
            <input
            ...
            <input
                ...
                onChange={(e) => 
                    setEditPatients({ ...editPatients, country: e.target.value})
                }
            />

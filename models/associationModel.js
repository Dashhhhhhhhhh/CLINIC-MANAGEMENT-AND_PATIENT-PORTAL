...
const { Hematology } = require('../modules/hematology/hematology.model');
const { Result } = require('../modules/results/result.model');
const { TestTypes } = require('../modules/testTypes/testTypes.model');
const { Urinalysis } = require('../modules/urinalysis/urinalysis.model');
const { Xray } = require('../modules/xray/xray.model');
const { Ultrasound } = require('../modules/ultrasound/ultrasound.model');

...
require('./modules/testTypes/testTypes.model');
require('./modules/hematology/hematology.model');
require('./modules/urinalysis/urinalysis.model');
require('./modules/xray/xray.model');
require('./modules/ultrasound/ultrasound.model');
...
const hematologyRoutes = require('./modules/hematology/hematology.routes');
const testTypesRoutes = require('./modules/testTypes/testTypes.routes');
const resultRoutes = require('./modules/results/result.routes');
const urinalysisRoutes = require('./modules/urinalysis/urinalysis.routes');
const xrayRoutes = require('./modules/xray/xray.routes');
const ultrasoundRoutes = require('./modules/ultrasound/ultrasound.routes');
